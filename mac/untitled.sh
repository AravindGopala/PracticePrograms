...
FILTER="$TC filter add dev $interface protocol all parent 1: prio 1 u32"
...
function start_tc { 
    ...
    $FILTER match u32 0 0 flowid 1:10
    $TC filter add dev $interface protocol all parent 1: prio 1 handle 6 fw flowid 1:30
